...
const tableRows = [
  ...
  ["activity_log", "Journal d'activité : connexions, changements de statut, dépôts de photo — consultable par l'admin (qui fait quoi, quand)."],
];

const employeeFeatures = [
  "Connexion via Google ou email/mot de passe",
  "Planning personnel : liste des tâches à venir groupées par jour",
  "Détail d'une tâche : appartement, adresse, consignes",
  "Changement de statut d'une tâche (à faire → en cours → terminé / reporté)",
  "Dépôt de photos directement depuis le mobile (appareil photo ou galerie)",
  ...
  sections: [
    {
      ...
      children: [
        ...
        bullet("Peupler des données réelles (appartements, employés, planning) — le dashboard est fonctionnel mais vide."),
